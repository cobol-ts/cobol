...
describe(
    ...
    () => {
        ...
        it(
            "reports the real data file size",
            async () => {
                const file =
                    await stat(
                        dataFilename,
        ...
        it(
            "dumps the first two candidate 60 byte records",
            async () => {
                const bytes =
                    await readFile(
                        dataFilename,
                ...
                for (
                    ...
                    for (
                        ...
                        console.log(
                            `${offset.toString().padStart(3, " ")}  ${hex}  ${ascii}`,
                        );
                    }
                }
            },
        ...
        it.skip(
            "has a data file containing complete records",
            async () => {
                const file =
                    await stat(
                        dataFilename,
